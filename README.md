# Friday Pharma (ফ্রাইডে ফার্মা)

> সহজ হিসাব, নিরাপদ ব্যবস্থাপনা — বাংলাদেশের ছোট ফার্মেসির জন্য ব্যবস্থাপনা অ্যাপ।

সম্পূর্ণ **offline-first** PWA। ইন্টারনেট ছাড়াই সব কাজ চলে — বিক্রয়, স্টক, বাকি, খরচ — কারণ সব ডেটা আগে এই ডিভাইসেই (IndexedDB) জমা হয়। লগইন হয় **৮ সংখ্যার PIN** দিয়ে।

প্রতিটি ফার্মেসি সেটিংসে নিজের দোকানের নাম দেয়; অ্যাপের নাম Friday Pharma, দোকানের নাম আলাদা।

> **আসছে:** অ্যাকাউন্ট ও লগইন, কর্মচারী যোগ করা, এবং একাধিক ডিভাইসে sync। এক ফার্মেসির ডেটা অন্য কেউ দেখতে পারবে না — নিয়মটি ডেটাবেসেই বসানো। পরিকল্পনা: **[docs/SAAS-ROADMAP.md](docs/SAAS-ROADMAP.md)**।
...
- **রিপোর্ট** — দৈনিক, মাসিক ও ইনভেন্টরি, সাথে CSV export। মুনাফা = বিক্রয় − বিক্রীত মালের ক্রয়মূল্য; রিটার্ন বাদ দিয়ে হিসাব হয়। দিন গোনা হয় ফোনের স্থানীয় তারিখ ধরে (মধ্যরাত থেকে মধ্যরাত)
...
supabase/        সার্ভারের schema ও Row Level Security (এখনো যুক্ত নয়)
